    ...
    <div className="min-h-screen bg-paper antialiased">
      ...
      <ServicePageTemplate
        c={{
          ...
          priceNote: '$395/month. $1,500 setup, waived with a 12-month commitment.',
          ...
          faqs: [
            { q: 'How much does it cost?', a: 'It is $395 a month, plus a one-time $1,500 setup fee that is waived if you commit for 12 months. Most organizations take the 12-month option because it saves money from day one.' },
