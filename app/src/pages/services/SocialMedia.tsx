    ...
    <div className="min-h-screen bg-paper antialiased">
      ...
      <ServicePageTemplate
        c={{
          ...
          plans: [
            {
              name: 'Starter',
              price: '$495/mo',
              setup: '4 posts/week · $900 setup, waived with 12-month plan',
              items: [
                '3 graphics a week',
                '1 carousel a week',
                'Facebook + Instagram',
            ...
            },
            {
              name: 'Plus',
              price: '$795/mo',
              setup: '6 posts/week · $900 setup, waived with 12-month plan',
              popular: true,
              items: [
            ...
            },
            {
              name: 'Premium',
              price: '$995/mo',
              setup: '7 posts/week · $900 setup, waived with 12-month plan',
              items: [
          ...
          faqs: [
            { q: 'How much does it cost?', a: 'Plans are $495 (Starter), $795 (Plus), and $995 (Premium) per month, plus a one-time $900 setup fee that is waived on a 12-month plan.' },
            ...
            { q: 'Is there a contract or setup fee?', a: 'Plans run on a 12-month agreement with a one-time $900 setup fee, waived on that plan. After the first year you continue month-to-month and can cancel anytime.' },
