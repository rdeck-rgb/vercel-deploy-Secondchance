...
export default function GoogleAdGrant() {
  return (
    <div className="min-h-screen bg-paper antialiased">
      <PageMeta
        title="Google Ad Grant Management for Nonprofits — $395/mo | SecondChance Media"
        description="$10,000/month in free Google Ads for qualifying 501(c)(3) animal organizations. We handle the application, compliance, and campaigns. $395/month management."
      />
      <SiteHeader />
      <ServicePageTemplate
        c={{
